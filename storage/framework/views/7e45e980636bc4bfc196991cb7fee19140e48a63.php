    ...
    <div class="container-fluid">
        <div class="row">
            <div class=" col-md-12">
                ...
                <form action="<?php echo e(route('admin-sales-report-result')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-striped"  id="فروش">
                        ...
                        <tr>
                            ...
                            <td><?php echo e(number_format($book->sum)); ?> تومان</td>
                        </tr>
